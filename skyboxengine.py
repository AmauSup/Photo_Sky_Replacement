...
class SkyBox():
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.gf_eps = 1e-3
        self.gf_radius_factor = 1 / 150
        self.top_seed_ratio = 0.35
        self.allow_thr_all = 0.18
        self.fade_band_px = 120
        self.monotone_decay_px = 2

        # === MODIFICATIONS ICI ===
        self.halo_strength = getattr(args, "halo_strength", 0.15)
        self.relighting_factor = getattr(args, "relighting_factor", 0.1)  # lumière du ciel
        self.recoloring_factor = getattr(args, "recoloring_factor", 0.0)  # color matching minimal
